...
VALUES
    ('BAT-001', 'Li-ion', 4, 5000, 120, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-002', 'Li-ion', 6, 6000, 150, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-003', 'LiPo', 3, 4500, 110, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-004', 'Li-ion', 4, 5200, 130, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-005', 'LiPo', 6, 7000, 170, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-006', 'NiMH', 8, 3000, 90, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-007', 'Li-ion', 4, 4800, 140, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-008', 'LiPo', 5, 5200, 150, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-009', 'Li-ion', 6, 6500, 160, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-010', 'LiPo', 3, 5000, 120, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-011', 'NiMH', 8, 3100, 95, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-012', 'Li-ion', 4, 4700, 130, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-013', 'LiPo', 5, 4900, 140, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-014', 'Li-ion', 6, 6800, 180, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('BAT-015', 'LiPo', 4, 5100, 115, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);


INSERT INTO flight_battery (id, flight_number, battery_serial_num)
VALUES
    (1, 'FL001', 'BAT-001'),
    (2, 'FL001', 'BAT-002'),
    (3, 'FL002', 'BAT-003'),
